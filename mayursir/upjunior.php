<form method = "post">
<h1 style="background-color:yellow;">Paritcipants of junior</h1>
...
<a href="jrresult.php">Junior Result</a>&nbsp &nbsp &nbsp
...
error_reporting(0);
			...
			mysqli_select_db($con,"sports");
					...
					if(isset($_POST["submit"]))
					{
						...
						$cjmax = $_POST["cjmax"];
						$total = $snmax + $cjmax;
						$q="update junior set  sn1=$sn1,sn2=$sn2,sn3=$sn3,snmax=$snmax,cj1=$cj1,cj2=$cj2,cj3=$cj3,cjmax=$cjmax,total=$total where lotno=$lt";
							if(mysqli_query($con,$q))
							{
								echo "Updated in junior";
							}
							else{
								echo "Error in junior";
								}
					...
					{
						$lt = $_POST["ln"];
						$q= "select * from junior where lotno=$lt";
					...
					elseif(isset($_POST["allp"]))
					{
						header("Location:alljr.php");
					}*/
